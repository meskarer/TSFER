...
class Job:
    def __init__(self, one_task_fair_share, one_task_duration,
                 first_task_arrival_time, demanded_res,
                 mice, sta_t, sta_jct):
        """
        ...
        self.one_task_fair_share = one_task_fair_share
        self.active_fair_share = 0.0
