...
#                         del(cru_finished_log)
                        ...
                        if sys.argv[3] == 'a':
                            ...
                            boost.df.to_csv(os.path.join(j_l, f"indivis_boost_bwmhz{bw_list[0]}_slot{int(slot_duration)}.csv"))
                            event_df.to_csv(os.path.join(j_l, f"indivis_event_bwmhz{bw_list[0]}_slot{int(slot_duration)}.csv"))
