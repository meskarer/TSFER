...
#         slot_dur_list = [16.0, 64.0, 256.0, 1024.0]
        ...
        rho_list = [0]
        nu_list = [0]
        slot_dur_list = [1024.0, 256.0, 46.0]
                ...
                for bwmhz in bw_list:
                    for rho in rho_list:
                        ...
                        if sys.argv[3] == 'a':
                            ...
                            boost.df.to_csv(os.path.join(j_l, f"indivis_boost_bwmhz{bw_list[0]}_slot{int(slot_duration)}_cru.csv"))
                            event_df.to_csv(os.path.join(j_l, f"indivis_event_bwmhz{bw_list[0]}_slot{int(slot_duration)}_cru.csv"))
