    ...
    def run(self):
        ...
        while self.sim_not_over():
            if self.arrival_event():
                ...
                num_task_dct[self.time_current] = {j_id: j.active_fair_share/j.one_task_fair_share for j_id, j in self.running_log.running_job_dct.items()}
...
class Slotted_TSFER_env(Abs_egal_slotted_env):
    def __init__(self, input_dict, arrival_tracker, execution_tracker, departure_tracker):
        ...
        self.event_log_path = os.path.join(self.RW_path, 'event_log_tsfer.csv')
        self.job_log_path = os.path.join(self.RW_path, 'job_log_tsfer.csv')
        self.task_log_path = os.path.join(self.RW_path, 'task_log_tsfer.csv')


class Slotted_DRFER_env(Abs_egal_slotted_env):
    def __init__(self, input_dict, arrival_tracker, execution_tracker, departure_tracker):
        super().__init__(input_dict, arrival_tracker, execution_tracker, departure_tracker)
        self.event_log_path = os.path.join(self.RW_path, 'event_log_drfer.csv')
        self.job_log_path = os.path.join(self.RW_path, 'job_log_drfer.csv')
        self.task_log_path = os.path.join(self.RW_path, 'task_log_drfer.csv')


class Slotted_Naive_TSF_env(Abs_egal_slotted_env):
    def __init__(self, input_dict, arrival_tracker, execution_tracker, departure_tracker):
        super().__init__(input_dict, arrival_tracker, execution_tracker, departure_tracker)
        self.event_log_path = os.path.join(self.RW_path, 'event_log_naive_tsf.csv')
        self.job_log_path = os.path.join(self.RW_path, 'job_log_naive_tsf.csv')
        self.task_log_path = os.path.join(self.RW_path, 'task_log_naive_tsf.csv')


class Slotted_Naive_DRF_env(Abs_egal_slotted_env):
    def __init__(self, input_dict, arrival_tracker, execution_tracker, departure_tracker):
        super().__init__(input_dict, arrival_tracker, execution_tracker, departure_tracker)
        self.event_log_path = os.path.join(self.RW_path, 'event_log_naive_drf.csv')
        self.job_log_path = os.path.join(self.RW_path, 'job_log_naive_drf.csv')
        self.task_log_path = os.path.join(self.RW_path, 'task_log_naive_drf.csv')
